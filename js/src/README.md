...
| `index.js` | the single public entry point; `package.json`'s `exports` map exposes nothing else; `test/index.test.js` pins the 232 public names |
...
Python); the neural BUSTED head. Every method module of `hyphaeon/*.py` in PLAN.md §5.1 is now
ported (`epistasis.py`, `phenotype.py` included).

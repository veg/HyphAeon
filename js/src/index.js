...
export * from './temporal.js'; // temporal.py:337-760: the temporal-selection pillar's arithmetic - regimes, root anchoring, directional attribution, Nadaraya-Watson smoothing, the sweep metric, the energy floors, the date-shuffling null kernel, the fPCA gate, the wave decomposition and the four-way classification (the ingestion, the worker, the chunking and the sentences are the app's)
